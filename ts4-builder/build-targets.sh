...
# projects repos
CP_VETROL_VDM_REPO=cp-vetrol-vdm
CP_SITROL_NM_REPO=cp-sitrol-nm
CP_VETROL_BKN_REPO=cp-vetrol-bkn
CP_VETROL_SI_REPO=cp-vetrol-si
CP_VAL_REPO=cp-val
CI_REPO=vetrol-ci
CP_MMK_REPO=cp-mmk
CP_GBH_REPO=cp-gbh
...
buildAll () {
   ...
   ${BUILD_MAIN_GLOBAL}   ${SKF_EXT_REPO}       ${TS4_USKAT_REPO}
   ...
   ${BUILD_MAIN_GLOBAL}   ${SKF_USERS_REPO}    "${SKF_EXT_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_GLOBAL}   ${SKF_REFBOOKS_REPO} "${SKF_EXT_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_GLOBAL}   ${SKF_REPORTS_REPO}  "${SKF_EXT_REPO} ${SKF_DQ_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_NONE}     ${SKF_JOURNALS_REPO} "${SKF_EXT_REPO} ${SKF_DQ_REPO}" ${TS4_CONCURRENT}
   echo "waiting for ${TARGETS_ID} platform building (part 2) to be completed..."
   wait

   ${BUILD_MAIN_GLOBAL}   ${SKF_ONEWS_REPO}    "${SKF_EXT_REPO} ${SKF_USERS_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_LOCAL}    ${SKF_ALARMS_REPO}   "${SKF_EXT_REPO} ${SKF_REPORTS_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ...
   ${BUILD_MAIN_LOCAL}    ${SKF_DEVS_REPO}     "${SKF_EXT_REPO} ${SKF_DQ_REPO} ${SKF_RRI_REPO} ${SKF_REPORTS_REPO} ${SKF_BRIDGE_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_LOCAL}    ${SKF_GENERAL_REPO}  "${SKF_EXT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_LOCAL}    ${SKT_VETROL_REPO}   "${SKF_EXT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO} ${SKF_SAD_REPO} ${SKF_HA_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_LOCAL}    ${SKT_SITROL_REPO}   "${SKF_EXT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO} ${SKF_SAD_REPO} ${SKF_HA_REPO}" ${TS4_CONCURRENT}
   ...
   ${BUILD_MAIN_LOCAL}    ${CP_VETROL_VDM_REPO}  "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO}  ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO}  ${TS4_SKIDE_REPO} ${SKF_GENERAL_REPO}"  ${TS4_CONCURRENT}
   ...
   ${BUILD_MAIN_LOCAL}    ${CP_VETROL_SI_REPO}   "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO}  ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO}  ${TS4_SKIDE_REPO}"  ${TS4_CONCURRENT}
