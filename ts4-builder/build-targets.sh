...
buildAll () {
   ...
   ${BUILD_MAIN_LOCAL}    ${CP_VETROL_VDM_REPO}  "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO}  ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO}  ${TS4_SKIDE_REPO}"  ${TS4_CONCURRENT}
