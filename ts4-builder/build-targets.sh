...
buildAll () {
   ...
   ${BUILD_MAIN_LOCAL}    ${SKT_SITROL_REPO}   "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO}" ${TS4_CONCURRENT}
