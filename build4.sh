...
buildAll () {
  ...
  buildTarget ${SKF_BRIDGE_REPO} ${TS4_USERS_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_DQ_REPO} ${TS4_BRIDGE_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_ONEWS_REPO} ${TS4_DQ_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_GGPREFS_REPO} ${TS4_ONEWS_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_REFBOOKS_REPO} ${TS4_GGPREFS_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_RRI_REPO} ${TS4_REFBOOKS_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKF_MNEMO_REPO} ${TS4_RRI_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
  ...
  buildTarget ${SKT_VETROL_REPO} ${TS4_MNEMO_REPO} ${GIT_MAIN_BRANCH} ${BUILD_MODE} ${GIT_DO_NOT_COMMIT}
  case $? in
