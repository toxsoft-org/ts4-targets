...
buildAll () {
   ...
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_RRI_REPO}      ${TS4_SKIDE_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL}
   ...
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_REFBOOKS_REPO} ${TS4_SKIDE_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL}
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_REPORTS_REPO}  ${SKF_DQ_REPO}       ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL}
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${TS4_L2_REPO}       ${SKF_DQ_REPO}       ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL}
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_LEGACY_REPO}   ${TS4_USKAT_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL}

   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_JOURNALS_REPO} ${SKF_REFBOOKS_REPO} ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE}  &
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_GGPREFS_REPO}  ${SKF_ONEWS_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE}  &
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_ALARMS_REPO}   ${SKF_ONEWS_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_LOCAL} &
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_BRIDGE_REPO}   ${SKF_USERS_REPO}    ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE}  &
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_MNEMO_REPO}    ${SKF_REPORTS_REPO}  ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE}  &
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKF_DEVS_REPO}     ${TS4_L2_REPO}       ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE}  &

   # multithread building
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKT_VETROL_REPO}   ${SKF_LEGACY_REPO}   ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL} &
   # ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKT_SITROL_REPO}   ${SKF_LEGACY_REPO}   ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_GLOBAL} &
