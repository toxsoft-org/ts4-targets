...
buildAll () {
   ...
   ${BUILD_MAIN_NONE}     ${SKF_MNEMOS_REPO}    "${TS4_USKAT_REPO} ${SKF_REPORTS_REPO} ${SKF_RRI_REPO} ${TS4_SKIDE_REPO}" &

   echo "waiting for ${TARGETS_ID} platform building (part 4) to be completed..."
   wait

   ${BUILD_MAIN_LOCAL}    ${SKF_DEVS_REPO}     "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_RRI_REPO} ${SKF_REPORTS_REPO} ${SKF_BRIDGE_REPO} ${TS4_SKIDE_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${SKF_GENERAL_REPO}  "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO}" &
   ...
   ${BUILD_MAIN_LOCAL}    ${SKT_SITROL_REPO}   "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO}" &
   ...
   ${BUILD_MAIN_LOCAL}    ${CP_SITROL_NM_REPO}   "${SKT_SITROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CP_VETROL_BKN_REPO}  "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CP_VAL_REPO}         "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CI_REPO}             "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO} ${SKF_LEGACY_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CP_MMK_REPO}         "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_ALARMS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CP_GBH_REPO}         "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO} ${SKF_LEGACY_REPO}" &
   ${BUILD_MAIN_LOCAL}    ${CP_GWP_REPO}         "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO} ${SKF_LEGACY_REPO}" &
   ${BUILD_MASTER_LOCAL}  ${MCC_REPO}            "${SKT_VETROL_REPO} ${SKF_RRI_REPO} ${SKF_REFBOOKS_REPO} ${SKF_REPORTS_REPO} ${SKF_JOURNALS_REPO} ${SKF_MNEMOS_REPO} ${SKF_USERS_REPO} ${SKF_BRIDGE_REPO} ${SKF_DEVS_REPO} ${TS4_SKIDE_REPO} ${SKF_LEGACY_REPO}" &
