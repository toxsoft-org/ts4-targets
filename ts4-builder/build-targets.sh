...
buildAll () {
   ...
   ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKT_VETROL_REPO}   ${SKF_LEGACY_REPO}   ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE} &
   # ${TARGETS_BUILD_REPO_CMD} "${BUILT_DATE}" ${SKT_SITROL_REPO}   ${SKF_LEGACY_REPO}   ${GIT_MAIN_BRANCH} ${TARGETS_OUTPUT_NONE} &
