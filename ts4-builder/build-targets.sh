...
buildAll () {
   ...
   ${BUILD_MAIN_LOCAL}    ${SKT_VETROL_REPO}   "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO} ${SKF_SAD_REPO} ${SKF_HA_REPO}" ${TS4_CONCURRENT}
   ${BUILD_MAIN_LOCAL}    ${SKT_SITROL_REPO}   "${TS4_USKAT_REPO} ${SKF_DQ_REPO} ${SKF_ALARMS_REPO} ${SKF_RRI_REPO} ${SKF_ONEWS_REPO} ${SKF_BRIDGE_REPO} ${SKF_LEGACY_REPO} ${TS4_SKIDE_REPO} ${SKF_SAD_REPO} ${SKF_HA_REPO}" ${TS4_CONCURRENT}
